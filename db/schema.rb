...
ActiveRecord::Schema.define(version: 2020_07_31_051934) do
  ...
  create_table "applications", force: :cascade do |t|
    ...
    t.index ["issue_id"], name: "index_applications_on_issue_id"
  end
  ...
  create_table "relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["primary_account_id", "secondary_account_id"], name: "index_relationships_on_account_ids_unique", unique: true
